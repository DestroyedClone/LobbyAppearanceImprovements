...
namespace LobbyAppearanceImprovements
{
    public static class LAILanguage
    {
        ...
        public static void Init()
        {
            ...
            LanguageAPI.Add("LAI_MAP_SEER_FORMAT", "<style=cWorldEvent>{0}</cWorldEvent>");
            ...
            //SEER
            LanguageAPI.Add("LAI_SEER_ARENA", "You dream of data.");
            LanguageAPI.Add("LAI_SEER_ARTIFACTWORLD", "You dream of change.");
            LanguageAPI.Add("LAI_SEER_BAZAAR", "You dream of the timestream.");
            LanguageAPI.Add("LAI_SEER_CAPTAINSHELM", "You dream of excitement.");
            LanguageAPI.Add("LAI_SEER_ECLIPSE", "You dream of synchronity.");
            LanguageAPI.Add("LAI_SEER_LIMBO", "You dream of loneliness.");
            LanguageAPI.Add("LAI_SEER_LOBBY", "You dream of friendship.");
            LanguageAPI.Add("LAI_SEER_LOBBYVOID", "Y?u dr?a? o? fr???dsh?p.");
