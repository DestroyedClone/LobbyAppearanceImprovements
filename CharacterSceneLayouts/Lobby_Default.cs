...
namespace LobbyAppearanceImprovements.CharacterSceneLayouts
{
    public class Lobby_Default : CharSceneLayout
    {
        ...
        public override Dictionary<string, CameraSetting> CharacterCameraSettings => new Dictionary<string, CameraSetting>()
        {
            ...
            {"SniperClassicBody", new CameraSetting( 6, 0.5f, -12.5f ) },
            {"EnforcerBody", new CameraSetting( 11, -1, 10 ) },
            {"NemesisEnforcerBody", new CameraSetting( 10, -7.5f, 8 ) },
            {"BanditReloadedBody", new CameraSetting( 20, 1, -30 ) },
            {"HANDOverclockedBody", new CameraSetting( 8, -2, -4 ) },
            {"MinerBody", new CameraSetting( 17, 1, -26 ) },
            {"RobPaladinBody", new CameraSetting( 9, -1, -10 ) },
            {"CHEFBody", new CameraSetting( 5, -8.5f, 3 ) },
            {"RobHenryBody", new CameraSetting( 12, -7, -27 ) },
            {"WyattBody", new CameraSetting( 12, -2, -22 ) },
            {"CustodianBody", new CameraSetting( 12, -2, -22 ) },
            {"ExecutionerBody", new CameraSetting( 8, -0.25f, 3.75f ) },
            {"NemmandoBody", new CameraSetting( 20, 1, 30 ) },
        };
    }
}