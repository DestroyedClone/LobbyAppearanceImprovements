...
namespace LobbyAppearanceImprovements.Scenes
{
    public class BlackBeach : LAIScene
    {
        ...
        public override Vector3 Position => new(0f, -2.4f, 5);
        public override Quaternion Rotation => new();
        ...
        public override void Init()
        {
            ...
            CloneFromAddressable("RoR2/Base/blackbeach/BBSkybox.prefab", display.transform);
