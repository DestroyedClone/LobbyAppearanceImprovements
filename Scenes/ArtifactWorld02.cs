...
{
    public class ArtifactWorld02 : LAIScene
    {
        public override string SceneNameToken => "MAP_ARTIFACTWORLD02";
        public override string SeerToken => "LAI_SEER_ARTIFACTWORLD";
        public override GameObject BackgroundPrefab => display;
        public override Vector3 Position => new Vector3(-9, - 8, 32);
        ...
        {
            base.Init();
            display = PrefabCloneFromAddressable("RoR2/DLC2/artifactworld02/Artifactworld02DioramaDisplay.prefab", "LAI_Scene_ArtifactWorld");
