...
namespace LobbyAppearanceImprovements.Scenes
{
    public class SulfurPools : LAIScene
    {
        ...
        public override Material SkyboxOverride => LoadAsset<Material>("RoR2/DLC1/sulfurpools/matSkyboxSP.mat");
        public override string MusicTrackName => "muGameplayDLC1_06";
    }
}